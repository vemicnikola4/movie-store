...
export default function Carts({carts,message}){
                                                ...
                                                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={ind}>
                                                    ...
                                                    <td>
                                                        <div className="grid grid-cols-3 gap-1">
                                                            ...
                                                            <div>
                                                                <a href={route('admin.cart.show', cartItem.id)}className="text-green-700 font-bold hover:text-underlined">See More</a>
